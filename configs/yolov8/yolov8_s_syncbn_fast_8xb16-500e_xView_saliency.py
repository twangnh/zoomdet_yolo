...
# -----data related-----
data_root = '/root/autodl-tmp/xView/xView/'  # Root path of data
# Path of train annotation file
train_ann_file = 'train_anno.json'
train_data_prefix = 'train/'  # Prefix of train image path
# Path of val annotation file
val_ann_file = 'val_anno.json'
val_data_prefix = 'val/'  # Prefix of val image path

class_name = ("Fixed-wing Aircraft", "Small Aircraft", "Passenger/Cargo Plane", "Helicopter",
              "Passenger Vehicle", "Small Car", "Bus", "Pickup Truck", "Utility Truck",
              "Truck", "Cargo Truck", "Truck Tractor w/ Box Trailer", "Truck Tractor",
              "Trailer", "Truck Tractor w/ Flatbed Trailer", "Truck Tractor w/ Liquid Tank",
              "Crane Truck", "Railway Vehicle", "Passenger Car", "Cargo/Container Car",
              ...
              "Dump Truck", "Haul Truck", "Scraper/Tractor", "Front loader/Bulldozer",
              ...
              "Shipping Container", "Pylon", "Tower")  # 数据集类别名称
...
model = dict(
    ...
    train_cfg=dict(
        ...
        saliency_loss_weight=dict(
            weight=0.5,
            small_threshold=0.695,
            medium_threshold=0.695,
            large_threshold=0.695
        )),
...
optim_wrapper = dict(
    ...
    paramwise_cfg=dict(
        ...
        custom_keys={'saliency_network': dict(lr_mult=0.1, decay_mult=1.0)}),
    constructor='YOLOv5OptimizerConstructor')

# optim_wrapper_detector = dict(
#     type='OptimWrapper',
#     clip_grad=dict(max_norm=10.0),
#     optimizer=dict(
#         type='SGD',
...
# optim_wrapper = dict(
#     optim_saliency=optim_wrapper_saliency,
#     optim_detector=optim_wrapper_detector
# )
