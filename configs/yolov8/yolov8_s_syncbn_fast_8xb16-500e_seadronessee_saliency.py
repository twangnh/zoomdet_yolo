...
# -----data related-----
data_root = '/root/autodl-tmp/seadronesee/'  # Root path of data
...
class_name = ('ignored', 'swimmer', 'boat', 'jetski', 'life_saving_appliances', 'buoy')
...
dataset_type = 'YOLOv5SeadroneseeDataset'
