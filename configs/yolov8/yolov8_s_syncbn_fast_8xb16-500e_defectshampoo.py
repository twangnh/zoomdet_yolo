...
# -----data related-----
data_root = '/root/autodl-tmp/defect_shampoo/'  # Root path of data
...
class_name = ('Dents', 'dent_marginal', 'dent_unacceptable',) # 数据集类别名称
...
dataset_type = 'YOLOv5defectshampooDataset'
