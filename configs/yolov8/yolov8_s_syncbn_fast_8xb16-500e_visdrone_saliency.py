...
# -----data related-----
data_root = '/root/autodl-tmp/visdrone/'  # Root path of data
# Path of train annotation file
train_ann_file = 'VisDrone2019-DET-train/my_train.json'
train_data_prefix = 'VisDrone2019-DET-train/images/'  # Prefix of train image path
# Path of val annotation file
val_ann_file = 'VisDrone2019-DET-val/my_val.json'
...
class_name = ('pedestrian', 'people', 'bicycle',
              ...
              'awning-tricycle', 'bus', 'motor')  # 数据集类别名称
...
model_test_cfg = dict(
    ...
    max_per_img=300,
    area_box_num_sum=0,
    area_box_num_sum_small=0,
    area_box_num_sum_medium=0,
    area_box_num_sum_large=0,
    area_sum=0,
    area_small_sum=0,
    area_medium_sum=0,
    area_large_sum=0,
...
dataset_type = 'YOLOv5VisdroneDataset'
...
optim_wrapper = dict(
    ...
    paramwise_cfg=dict(
        ...
        custom_keys={'offset_conv': dict(lr_mult=0.001, decay_mult=1.0)}),
