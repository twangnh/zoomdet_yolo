...
# -----data related-----
data_root = '/root/autodl-tmp/pcbdata/'  # Root path of data
# Path of train annotation file
train_ann_file = 'instances_train2014.json'
train_data_prefix = ''  # Prefix of train image path
# Path of val annotation file
val_ann_file = 'instances_test2014.json'
val_data_prefix = ''  # Prefix of val image path

class_name = ('open', 'short', 'mousebite', 'spur', 'copper', 'pin-hole') # 数据集类别名称
...
dataset_type = 'YOLOv5defectpcbDataset'
