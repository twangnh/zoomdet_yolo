...
# -----data related-----
data_root = '/root/autodl-tmp/UAVDT/UAVDT_train_test/'  # Root path of data
# Path of train annotation file
train_ann_file = 'train.json'
train_data_prefix = 'train_imgs/all'  # Prefix of train image path
# Path of val annotation file
val_ann_file = 'test.json'
val_data_prefix = 'test_imgs/all'  # Prefix of val image path

class_name = ('car', 'truck', 'bus')  # 数据集类别名称
