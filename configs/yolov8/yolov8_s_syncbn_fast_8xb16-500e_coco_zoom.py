...
load_from = '/root/autodl-tmp/mmyolo_orig/yolov8_s_syncbn_fast_8xb16-500e_coco_baseline/epoch_500.pth'
...
optim_wrapper = dict(
    ...
    paramwise_cfg=dict(
        ...
        custom_keys={'offset_conv': dict(lr_mult=1.0, decay_mult=1.0)}),
