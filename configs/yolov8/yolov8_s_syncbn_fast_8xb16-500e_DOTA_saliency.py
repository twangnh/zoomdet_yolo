...
# -----data related-----
data_root = '/root/autodl-tmp/DOTA/DOTA/'  # Root path of data
# Path of train annotation file
train_ann_file = 'train/train.json'
train_data_prefix = 'train/train_images/'  # Prefix of train image path
# Path of val annotation file
val_ann_file = 'val/val.json'
val_data_prefix = 'val/val_images/'  # Prefix of val image path

class_name = ('plane', 'ship', 'storage-tank', 'baseball-diamond', 'tennis-court',
...
base_lr = 0.0025
max_epochs = 55  # Maximum training epochs
